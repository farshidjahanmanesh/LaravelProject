...
<footer>
    ...
    <div class="footer-top">
        <div class="masterpb-container">
            ...
            <div class="subtitle-logo"><p class="color-text first">لورم ایپسوم متن</p>
                <p class="black-text">لورم ایپسوم متن</p>
                <p class="color-text">لورم ایپسوم متن</p>
                <p class="black-text last">لورم ایپسوم متن</p></div>
    ...
    <div class="footer-bottom">
        <div class="masterpb-container">
            <span class="copyright">کلیه حقوق مادی و معنوی برای مجموعه برنامه نویسان محفوظ می باشد . هر گونه کپی برداری از محتوای آموزشی با ذکر منبع مجاز می باشد.<a
                    href="#"></a> </span>
